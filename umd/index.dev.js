...
/* harmony import */ var _views_univer_view_jsx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../views/univer-view.jsx */ "./src/views/univer-view.jsx");
...
class SendMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "material-icons secondary"
    }, "attach_file")), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
      href: "#",
      onClick: e => {
        e.preventDefault();
        this.handleAttachTable();
      },
      title: "Add table"
    }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
      className: "material-icons secondary"
    }, "table"))) : null, this.props.noInput ? quote || react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "hr thin"
